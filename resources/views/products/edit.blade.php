...
<div class="max-w-xl mx-auto
    ...
    <form method="POST"
        ...
        <div>
            ...
            <textarea
                ...
                class="w-full rounded-md
                       ...
                       text-gray-900 dark:text-gray-100
                       focus:ring-2 focus:ring-blue-500
                       focus:outline-none p-2">{{ old('category', $product->category) }}</textarea>
        </div>
            ...
            @if ($product->image)
                <div class="mb-2">
                    <img
                        ...
                        alt="Product Image"
                        class="h-24 w-24 object-cover rounded border border-gray-200 dark:border-gray-700">
                </div>
            @endif
        ...
        <div class="flex gap-3 pt-4">
            <button type="submit"
                class="bg-blue-600 dark:bg-blue-700
